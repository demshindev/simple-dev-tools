...
export default function StringEscape() {
  ...
  return (
    <div>
      <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">String Escape/Unescape</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
        <div>
          ...
          <textarea
            ...
            placeholder={mode === 'escape' ? 'Enter text...' : 'Enter escaped string...'}
          />
        </div>
        <div>
